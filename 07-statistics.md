...
>> The probability that Elvis had an identical twin is 125 / 425 which is equal to 29.4%.
...
>> Frequentist uses large amounts of data to draw conclusions. Bayesian has probabilities assigned to certain events which allow for statistics to be calculated or inferred with given prioris.
